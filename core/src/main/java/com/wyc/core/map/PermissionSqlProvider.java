...
import com.wyc.entity.PermissionExample.Criteria;
import com.wyc.entity.PermissionExample.Criterion;
...
public class PermissionSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPermissionName() != null) {
            SET("permission_name = #{record.permissionName,jdbcType=VARCHAR}");
        }
